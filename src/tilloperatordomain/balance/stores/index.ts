...
export const useBalance = defineStore("balance", () => {
  ...
  //     // const {data} = await api.post("/till-operator17-float-request-amount", payload.amount);
  //     const { data } = await api.post("/till-operator17-float-request-amount", {
  ...
  //     //post that float request to the api
  //     const { data } = await api.post("/till-operator17-float-request-amounts", {
  //       tillId: payload.tillId,
  //       amount: payload.amount,
  //       description: payload.description
  //     });
